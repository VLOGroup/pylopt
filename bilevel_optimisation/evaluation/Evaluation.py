...
from bilevel_optimisation.utils.SetupUtils import set_up_measurement_model, set_up_inner_energy, \
    set_up_outer_loss
from bilevel_optimisation.visualisation.Visualisation import visualise_test_triplets, visualise_filters
...
def evaluate_on_test_data(test_loader: torch.utils.data.DataLoader, regulariser: torch.nn.Module,
                          ...
                          denoised_image_subdir: str = 'denoised',
                          filter_image_subdir: str = 'filters') -> Tuple[float, float]:
